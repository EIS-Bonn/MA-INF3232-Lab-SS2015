...
public partial class ADensity : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      //  MSBar2DChart oChart = new MSBar2DChart();
        ...
        oChart.ChartTitles.Caption = "Population Density Comparison";
        ...
        oChart.DataSeriesValueField = "Density";
    ...
    private DataTable GetpopulationDataTable()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT Country,Year,Density FROM tblPopupation", con))
            {
