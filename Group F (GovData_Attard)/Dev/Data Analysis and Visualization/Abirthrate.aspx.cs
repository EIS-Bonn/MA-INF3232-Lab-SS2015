...
public partial class Abirthrate : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        oChart.ChartTitles.Caption = "Birth Rate Comparision";
    ...
    private DataTable GetpopulationDataTable()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT Country,Year,Birthrate FROM tblPopupation", con))
            {
