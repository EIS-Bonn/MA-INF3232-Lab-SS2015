...
public partial class Agrowthrate : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        oChart.ChartTitles.Caption = "Growth Rate Comparison";
        ...
        oChart.DataSeriesValueField = "Growthrate";
    ...
    private DataTable GetpopulationDataTable()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT Country,Year,Growthrate FROM tblPopupation", con))
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                {
                    using (DataTable dt = new DataTable())
                    {
                        ...
                        //gvAPopulation.AutoGenerateColumns = true;

                        //Set Columns Count
                        // gvAPopulation.colu
                        //gvAPopulation.ColumnCount = 3;
