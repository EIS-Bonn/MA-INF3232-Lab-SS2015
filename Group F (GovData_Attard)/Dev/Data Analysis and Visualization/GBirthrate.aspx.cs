...
public partial class GBirthrate : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       MSArea2DChart oChart = new MSArea2DChart();
        ...
        oChart.ChartTitles.Caption = "Birthrate of Germany (Birth/1000 Population) ";
    ...
    private DataTable GetpopulationDataTable()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT Year,Country,Birthrate FROM tblPopupation WHERE Country='Germany'", con))
            {
