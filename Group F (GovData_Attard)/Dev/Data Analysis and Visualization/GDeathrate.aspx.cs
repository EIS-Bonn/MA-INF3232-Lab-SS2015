...
public partial class GDeathrate : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      //  MSArea2DChart oChart = new MSArea2DChart();
        ...
        oChart.ChartTitles.Caption = "Deathrate of Germany (Death/1000 Population) ";
    ...
    private DataTable GetpopulationDataTable()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT Year,Country,Deathrate FROM tblPopupation WHERE Country='Germany'", con))
            {
