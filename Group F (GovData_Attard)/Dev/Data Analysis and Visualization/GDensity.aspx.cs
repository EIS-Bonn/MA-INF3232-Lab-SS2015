...
public partial class GDensity : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // Pie3DChart oChart = new Pie3DChart();
        ...
        oChart.ChartTitles.Caption = "Population Density of Germany ";
    ...
    private DataTable GetpopulationDataTable()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT Year,Density FROM tblPopupation WHERE Country='Germany'", con))
            {
