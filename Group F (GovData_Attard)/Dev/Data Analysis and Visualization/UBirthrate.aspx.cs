...
public partial class UBirthrate : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // MSColumn3DLineDYChart oChart = new MSColumn3DLineDYChart();
        ...
        oChart.ChartTitles.Caption = "Birthrate of United Kingdom (Birth/1000 Population) ";
        ...
        oChart.DataSeriesValueField = "Birthrate";
    ...
    private DataTable GetpopulationDataTable()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT Year,Country,Birthrate FROM tblPopupation WHERE Country='UK'", con))
            {
