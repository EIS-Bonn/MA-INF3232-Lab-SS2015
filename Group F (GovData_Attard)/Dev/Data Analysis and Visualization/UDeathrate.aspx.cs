...
public partial class UDeathrate : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        oChart.ChartTitles.Caption = "Death of United Kingdom (Death/1000 Population) ";
    ...
    private DataTable GetpopulationDataTable()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT Year,Country,Deathrate FROM tblPopupation WHERE Country='UK'", con))
            {
