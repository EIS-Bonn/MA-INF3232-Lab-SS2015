...
public partial class UPopulation : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        oChart.ChartTitles.Caption = "Population of United Kingdom last Years";
    ...
    private DataTable GetpopulationDataTable()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT Year,Country,Population FROM tblPopupation WHERE Country='UK'", con))
            {
