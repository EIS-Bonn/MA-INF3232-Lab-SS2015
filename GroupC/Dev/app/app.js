...
Ontology.prototype.reset = function() {
  this.ontologyName = "";
  this.triples = [];
  this.nodes = [];
  this.edges = [];
...
function initOntology(){
  ...
  ont.reset(); //like a constructor, but not really
  parsedOntology = ''; //reset parsed ontology
  ...
  function constructResponse(data) {
      ...
      _.each(data, function (item) {
        ...
        /*---------------------- ONTOLOGY NODES ------------------*/
        ont.addNode(subject, predicate, object);
      })
...
/**
 * Loads an ontology by reading local file
