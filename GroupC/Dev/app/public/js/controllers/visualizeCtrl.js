...
$scope.visualizeme = function (){
  ...
  $scope.title = 'Ontology manipulation:';
 ...
 ********************************/
 ...
 /**
  * Using JQuery to get json data callback func
  */
  function getnodes( callback ){
    jQuery.getJSON('http://localhost:4000/ontology/nodes', function(data) {
  ...
  function getedges( callback ){
    jQuery.getJSON('http://localhost:4000/ontology/edges', function(data) {
      // We can't use .return because return is a JavaScript keyword.
      callback(data);
    });
  }
  ...
  $(function () {
    $(document).ready(function() {
      getnodes( function ( value ) {
        $('#nodeJson').text(JSON.stringify(value));
      } );
      getedges( function ( value ) {
        $('#edgeJson').text(JSON.stringify(value));
      } );
    });
  });
