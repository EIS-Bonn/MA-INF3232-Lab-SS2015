...
public partial class APopulation : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      //  MSColumn3DLineDYChart oChart = new MSColumn3DLineDYChart();
        ...
        oChart.ChartTitles.Caption = "Population in last Years";
    ...
    private DataTable GetpopulationDataTable()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT Country,Year,Population FROM tblPopupation", con))
            {
