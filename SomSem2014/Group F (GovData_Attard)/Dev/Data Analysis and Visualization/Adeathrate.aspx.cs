...
public partial class Adeathrate : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      //  MSColumn3DChart oChart = new MSColumn3DChart();
        ...
        oChart.ChartTitles.Caption = "Death Rate Comparison";
    ...
    private DataTable GetpopulationDataTable()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT Country,Year,Deathrate FROM tblPopupation", con))
            {
