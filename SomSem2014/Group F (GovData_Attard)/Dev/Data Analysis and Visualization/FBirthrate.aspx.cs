...
public partial class FBirthrate : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // MSColumn3DChart oChart = new MSColumn3DChart();
        ...
        oChart.ChartTitles.Caption = "Birthrate of France (Birth/1000 Population) ";
    ...
    private DataTable GetpopulationDataTable()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT Year,Country,Birthrate FROM tblPopupation WHERE Country='France'", con))
            {
