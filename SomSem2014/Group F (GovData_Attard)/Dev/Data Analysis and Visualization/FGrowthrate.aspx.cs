...
public partial class FGrowthrate : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        oChart.ChartTitles.Caption = "Growthrate of France in % ";
    ...
    private DataTable GetpopulationDataTable()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT Year,Country,Growthrate FROM tblPopupation WHERE Country='France'", con))
            {
