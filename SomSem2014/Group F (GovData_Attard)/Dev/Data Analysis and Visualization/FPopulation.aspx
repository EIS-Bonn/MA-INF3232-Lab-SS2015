...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FPopulation.aspx.cs" Inherits="FPopulation" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
<fcl:FChart runat="server" ID="chtProductSales" Width="800" Height="600" Font-Size="Large "  />
