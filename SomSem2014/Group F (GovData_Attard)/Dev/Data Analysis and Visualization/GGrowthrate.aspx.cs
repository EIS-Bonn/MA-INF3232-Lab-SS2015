...
public partial class GGrowthrate : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      //  FunnelChart oChart = new FunnelChart();
        ...
        oChart.ChartTitles.Caption = "Growthrate of Germany in % ";
    ...
    private DataTable GetpopulationDataTable()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT Year,Country,Growthrate FROM tblPopupation WHERE Country='Germany'", con))
            {
