...
<table>
	<tr>
		<td>
		<div><b><?php echo _('Old Deck:'); ?></b><br>
		<div id="old_tree" class="with-scroll"></div>
		</div>
		</td>
		<td>
		<div><b><?php echo _('New Deck:'); ?></b><br>
	...
	<tr>
		<td colspan="2">
		<center><a class="btn" onclick="compare_decks()"> <?php echo _('Compare Decks'); ?> </a> <a
			class="btn info" onclick="compare_selected_slides()"> <?php echo _('Compare Selected Slides'); ?> </a></center>
		</td>
	</tr>
</table>
</div>