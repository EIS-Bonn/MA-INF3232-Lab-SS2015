...
function insertImageToEditor(){
	...
	$(function(){
		...
		if(no_images) {
			...
			alert('<?php echo _("Your media library is empty."); ?>');
		} else {
			addImages(images);
		}
