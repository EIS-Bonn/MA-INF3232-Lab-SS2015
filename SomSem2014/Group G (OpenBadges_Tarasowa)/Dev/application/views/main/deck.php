...
<p style="text-align:justify;"><? echo _("You are not currently in the editors list of this deck. Your changes to this slide might create a new revision of the deck. Please select one the following actions."); ?></p>
<ul>
<li>
<? echo _("<b>Perform minor edit</b>: <small>Select this option if you just want to fix a typo or contribute a small piece to this individual slide. The original author will be notified and can directly incorporate your revision.</small>"); ?>
</li>
<li>
...
<li>
<? echo _("<b>Create a new revision</b>: <small>This option will create a copy of this deck just for you - select this option, if you plan to substantially change the presentation. This will create a new fork/branch of this presentation. Please consider carefully whehter this is required, since merging changes back into the original revision is not (yet) well supported.</small>"); ?>
</li>
</ul>
 <br/> 
    <a class="btn" id="dialog_minor_edit"><? echo _("Perform a minor edit"); ?></a>
    <a class="btn success" id="dialog_apply_editorship"><? echo _("Apply for editorship"); ?></a>
    <a class="btn info" id="dialog_new_revision"><? echo _("Create a new revision"); ?></a>
    <a class="btn primary" id="dialog_cancel"><? echo _("Cancel"); ?></a>
    </div>
</div>
<div id="modal_dialog_editorship" class="modal hide fade">
    <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    <h3><? echo _("Confirmation"); ?></h3>
    </div>
    <div class="modal-body">
<p style="text-align:justify;"><? echo _("Your editorship request sent to the owner of the corresponding deck."); ?>
</p>
    </div>
	<div class="modal-footer">
		<a class="btn" id="dialog_editorship_minor_edit"><? echo _("Perform a minor edit"); ?></a>
...
<div id="modal_findreplace" class="modal hide fade">
    ...
    <p><b><? echo _("Find and Replace "); ?>--</b> "<span id="findreplace_node_title"></span>"</p>
    </div>
    <div class="modal-body">
    	<div class="row" id="row_find_term"><div class="span2" style="text-align:right;"><? echo _("Find what"); ?></div><div class="span3"><input type="text" id="findreplace_term" class="input span3 search-query" placeholder="Search"/></div><div class="span3" style="text-align:left;"><a class="btn success find-next-btn"><? echo _("Find Next"); ?></a> <a class="btn success find-prev-btn" style="display:none;"><? echo _("Find Previous"); ?></a></div></div>
    	<div class="row"><div class="span2" style="text-align:right;"><? echo _("Replace with"); ?></div><div class="span3"><input type="text" id="findreplace_replace" class="input span3 search-query" placeholder="Replace"/></div><div class="span3" style="text-align:left;"><a class="btn info" onclick="find_replace();"><? echo _("Replace"); ?></a><a class="btn primary" onclick="find_replace_all();"><? echo _("Replace All"); ?></a></div></div>
...
<div id="modal_dialog_minoredit" class="modal hide fade">
    <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    <h3><? echo _("Confirmation of Minor Changes"); ?></h3>
    </div>
    <div class="modal-body">
<p style="text-align:justify;"><? echo _("Your minor changes have been saved. The owner of the deck will check the changes for confirmation."); ?>
</p>
    </div>
	<div class="modal-footer">
...
<div id="modal_html_code" class="modal hide fade in" style="display: none;">
	<div class="modal-header">
		<a class="close pointer-cursor">×</a>
			<h3><? echo _("HTML Code"); ?></h3>
	</div>
	<div class="modal-body slide-code-modal">
		<div class="input">
			<textarea id="html_source_code" class="span8"><? echo _("HTML source code"); ?></textarea>
		</div>
	</div>
	<div class="modal-footer">
		<a class="btn" onclick="$('#modal_html_code').modal('hide');"><? echo _("Close"); ?></a><a class="btn info btn-small" onclick="revert_slide_changes();"><i class="icon-repeat"></i><? echo _("Revert Changes"); ?></a> <!--a class="btn primary" onclick="apply_source_code()">Apply</a--> 
	</div>
</div>
<div id="modal_math_code" class="modal hide fade in" style="display: none;">
	...
	<div class="modal-body">
		<div class="input">
			<textarea id="math_source_code" class="span8"><? echo _("\[ your LaTeX Code \]"); ?></textarea>
		</div>
		<span onclick="previewMathCode();" style="cursor:pointer;color:green;"><? echo _("Click here to Preview"); ?></span>
		<div class="input">
			<div id="math_source_preview" class="span8"></div>
		</div>		
	</div>
	<div class="modal-footer">
		<a class="btn primary" onclick="insert_math_code()"><? echo _("Insert"); ?></a>
	</div>
</div>
<div id="modal_code_snippet" class="modal hide fade in" style="display: none;">
	<div class="modal-header">
		<a class="close pointer-cursor">×</a>
			<h3><? echo _("Code Snippet"); ?></h3>
	</div>
	<div class="modal-body">
		<div class="clearfix">
			<div class="input">
	...
	<div class="modal-footer">
		<a class="btn primary" onclick="insert_code_snippet();"><? echo _("Insert"); ?></a>
	</div>
</div>
<div id="modal_share_link" class="modal hide fade in" style="display: none;">
	<div class="modal-header">
		<a class="close pointer-cursor">×</a>
			<h3><? echo _("Share Link"); ?></h3><span id="share_link_title"></span>
	</div>
	<div class="modal-body">
		<div class="clearfix">
			<div class="input">
				<input onclick="updateShareLinks(1)" type="radio"  name="selected_share_link" value="1" checked> <input type="text" id="link_current_item"  value="" class="span5"  style="cursor:text;" onclick="this.focus();this.select();" readonly="readonly" /><span class="help-inline"><? echo _("Link to the current item"); ?></span>
			</div>
		</div>
		<div class="clearfix">
			<div class="input">
				<input onclick="updateShareLinks(2)" type="radio"  name="selected_share_link" value="2" > <input type="text" id="link_latest_item"  value="" class="span5" style="cursor:text;" onclick="this.focus();this.select();" readonly="readonly" /><span class="help-inline"><? echo _("Link to the latest revision of this item"); ?></span>
			</div>
		</div>	
		<div class="clearfix">
			<div class="input">
				<input onclick="updateShareLinks(3)" type="radio"  name="selected_share_link" value="3"> <input type="text" id="link_user_latest_item"  value="" class="span5" style="cursor:text;" onclick="this.focus();this.select();" readonly="readonly" /><span class="help-inline"><? echo _("Link to your latest revision of this item"); ?></span>
			</div>
		</div>	
	</div>
	<div class="modal-footer">
...
<div id="exportToSco" class="modal hide">
    <div class="modal-header">
	<a class="close pointer-cursor">×</a>
	<h3><? echo _("Download a deck as a SCORM package"); ?></h3>
    </div>
    <div class="modal-body" style="max-height:none !important;">
        <form class="form-stacked" action="./">
            <legend><? echo _("Choose a format:"); ?></legend>
            ...
            <div class="actions">
                <button type="submit" class="success btn"><? echo _("Download"); ?></button>
            </div>
        </form>
    </div>
</div>
			...
			<span class="r_entity r_creativework" itemscope itemtype="http://schema.org/CreativeWork">
              ...
              <ul class="nav">
                <li id="language_list_trigger" class="dropdown">
                    <a style="cursor: pointer;" id="get_all_translations_link" onclick="getAllTranslations()"><span id="current_language_name"><? echo _("Language:"); ?> <b><?php echo $deck->language['name'];?></b></span><i id="lang_icon" class="icon-chevron-down"></i></a>
                ...
                <div id="current_language_null" style="display:<?php if ($deck->language['id']=='' && $user['is_authorized']): echo 'block'; else: echo 'none'; endif;?>" lang="">
                    <a style="cursor: pointer;" onclick="getLanguagesList('#select_language')"><? echo _("Set language"); ?></a>
                </div>     
                ...
                <div id="deck_follow_status" class="span2">
					...
					<a class="btn mini danger" onclick="follow($(this),'deck',<?php echo $deck->deck_id;?>)"><? echo _("Unfollow deck"); ?></a>
					<?php endif; ?>
					<?php if ($user['is_authorized'] && $user['id']!=$deck->owner->id && !$isFollowing): ?>
					<a class="btn mini success" onclick="follow($(this),'deck',<?php echo  $deck->deck_id;?>)"><? echo _("Follow deck"); ?></a>
					<?php endif; ?>
		</div>   
</header>
	...
	<section class="span-one-third" id="control-elements">
		<header> <!-- theme selector -->
			...
			<tr><td>
				...
				Theme <?php if($user['is_authorized']){?>&nbsp;(<a href="style/<?php echo $style; ?>/deck/<?php echo $_GET['deck']; ?>"><? echo _("Edit"); ?></a>)<?php }?>
		...
		<div style="text-align:right;" id="tree_tools">
			<small>[<span id="tree_collapse" title="Collapse All" class="collapse-nodes" onclick="$('#tree').jstree('close_all');"><? echo _("Collapse all"); ?></span>]</small>
			<small>[<span id="tree_expand" title="Expand All" class="expand-nodes" onclick="$('#tree').jstree('open_all');"><? echo _("Expand all"); ?></span>]</small>
			<small>[<span id="tree_scroll" title="Enable/Disable Scrollbar for Navigation" class="expand-nodes" onclick="toggleScrollToTree();"><? echo _("Scrollable"); ?></span>]</small>
		...
		<header>
			<nav>
				<ul class="tabs" data-tabs="tabs" id="item_tabs">
					<li class="active"><a href="#view" id="viewlink"><span><? echo _("View"); ?></span></a></li>
					<li><a href="#edit" id="editlink"><span><? echo _("Edit"); ?></span></a></li>
					<li><a href="#discussion" id="discussionlink"><span><? echo _("Discussion"); ?></span></a></li>
					<li><a href="#questions" id="questionslink"><span><? echo _("Questions"); ?></span></a></li>
                                        <li><a href="#history" id="historylink"><span><? echo _("History"); ?></span></a></li>
					<li><a href="#usage" id="usagelink"><span><? echo _("Usage"); ?></span></a></li>
                    <?php if($keynode){?>
                                        <li><a href="<?php echo $keynode_url; ?>" id="KeynodePlaySlide" target="_blank" title="Play Slides with KeynodeJS" class="btn mini"><i class="icon-play"></i></a></li>
                    <?php }else{ ?>
					<li><a href="play/deck/<?php echo $deck->id;?>" id="playSlide" target="_blank" title="Play Slides" class="btn mini"><i class="icon-play-circle"></i></a></li>
					<?php }?>
		...
		<section class="tab-content">
			...
			<div id="view" class="active"> 
				...
				<?php if(!$user['is_authorized']){?>
					...
					<a class="close pointer-cursor">×</a>
					<p><? echo _('Everybody can edit all content on SlideWiki. Please <a href="#login-register-modal" data-controls-modal="login-register-modal" data-backdrop="true" data-keyboard="true">login or register </a> to edit slides!</p>'); ?>
				</div>	 
				<?php }?> 
		<!-- Branding -->
		<?php if (count($brand)){?><div id="deck-brand" class="deck-brand-bar" style="display:none;"><a href="<?php echo $brand['url'];?>" id="deck-brand-url" target="_blank"><img id="deck-brand-image" class="deck-brand-image" src="<?php echo $brand['image'];?>" alt="brand" /></a> <span class="deck-brand-text" id="deck-brand-text"><?php echo $brand['text'];?></span></div><?php }?>				
				<div id="slideview" class="deck-container"></div>
                                <div style='float:right; margin:5px' id='deck_stream_button_div'>
                                    <button id='deck_stream_button' class='btn success mini' onclick='showShortDeckStream($(this).attr("deck_id"))' deck_id='<?php echo $deck->id;?>'><? echo _("Show latest activity"); ?></button>
                                </div>
					...
					<script id="deck_preview" type="text/x-jquery-tmpl">
                       {{if $data.translation_status=="translated"}}
                               <div class="google_banner" ><? echo _('The deck contains slides that were translated by <a href="http://translate.google.com">Google Translation</a> service'); ?></div>
                       {{/if}}
                       {{if $data.translation_status=="in_progress"}}
                               <div class="google_banner_wide"><? echo _("The deck is currently being translated and will be available in about ten minutes! Your changes to the current deck might be lost. See history for more details"); ?></div>
                       {{/if}}
						<div class="deck-contributors" style="display:none;">
									{{if description}}<? echo _("Original author:"); ?><br/><span id="original_bar">${description}</span><br/><br/>{{/if}}
									<small> {{if owner.id != initiator.id}}<? echo _("Initiator{{else}}Creator"); ?>{{/if}}:</small><br/>
									...
									{{if owner.id != initiator.id}}
										<br/><small><? echo _("Creator of the revision:"); ?></small><br/>				   		
									...
									{{if slide_contributors}}{{if slide_contributors.length>0}}
								  			 <br/><small><? echo _("Contributors:"); ?> </small></br>
								...
								{{if current_user_id}}
									{{if current_user_id!=owner.id}}
										...
										{{if is_followed_by_current_user==1}}
												<? echo _("Unfollow"); ?> ${item_name}
										{{else}}<? echo _("Follow"); ?> ${item_name}
										{{/if}}
										</a>
									{{/if}}
								{{/if}}
						...
						{{if description}}
						<div class="deck-description"><small><? echo _("Original Author:"); ?> <i>${description}</i></small></div><br/>
						{{/if}}
						{{if tags}}
						<div class="deck-tags"><small><? echo _("Tags:"); ?> {{html tags}}</small></div><br/>
						{{/if}}
                       {{each slides}}
							...
							<div class="slide {{if $value.position==1}}{{if $value.deck.id==$data.id}}first-slide{{else}}first-sub-slide{{/if}}{{/if}}" id="tree-${$value.deck.id}-slide-${$value.id}-${$value.position}-view">
                                                         {{if $value.translation_status!="original"}}
                                                            ...
                                                            <div class="google_banner" id="google_banner_${$value.id}">
                                                                <? echo _('The slide was translated from ${$data.parent_language.name} by <a href="http://translate.google.com">Google Translation</a> service'); ?>
									...
									<h2>
										<div class="slide-title" id="slide_title_tree-${$value.deck.id}-slide-${$value.id}-${$value.position}">
											{{if $value.title}}{{html $value.title}}{{else}}<?php if($user['is_authorized']){?>« <? echo _("Click to add title"); ?> »<?php }?>{{/if}}
										</div>
									</h2>
                                                                            
									</div>
									<div class="slide-body" id="slide_body_tree-${$value.deck.id}-slide-${$value.id}-${$value.position}" onclick="enableWYSISWYG(this)">
										{{if $value.body}}{{html $value.body}}{{else}}<?php if($user['is_authorized']){?><p>« <? echo _("Click to add text"); ?>»</p><?php }?>{{/if}}
									</div>
								</div></div>
								<div class="slide-metadata">
									<hr>
										<div class="slide-description" style="{{if !$value.description}}display:none;{{/if}}">
											<small><? echo _("Original Source:"); ?> <div class="slide-original-source" {{if current_user_id}}{{if current_user_id==$value.initiator.id}}contenteditable onclick="showDescBtns('tree-${$value.deck.id}-slide-${$value.id}-${$value.position}-view')" {{else}}{{if $value.is_editable_by_current_user}}contenteditable onclick="showDescBtns('tree-${$value.deck.id}-slide-${$value.id}-${$value.position}-view')" {{/if}}{{/if}}{{/if}}>{{html $value.description}}</div>&nbsp;&nbsp;<a class="btn mini" style="display:none;" onclick="saveSlideOriginalSource('tree-${$value.deck.id}-slide-${$value.id}-${$value.position}-view',${$value.slide_id})"> Save</a><a class="btn mini" style="display:none;" onclick="cancelOriginalSource('tree-${$value.deck.id}-slide-${$value.id}-${$value.position}-view')"> Cancel</a></small>
										</div>
						   	 		<small>Speaker Notes:</small>
									<div class="slide-note" id="slide_note_tree-${$value.deck.id}-slide-${$value.id}-${$value.position}">
										{{if $value.note}}{{html $value.note}}{{else}}<?php if($user['is_authorized']){?><p>« <? echo _("Click to add note"); ?>»</p><?php }?>{{/if}}	
									</div>
									{{if !$value.description}}
										{{if current_user_id}}{{if current_user_id==$value.initiator.id}}
											<small><a onclick="showSlideOriginalSource(this,'tree-${$value.deck.id}-slide-${$value.id}-${$value.position}-view');" style="cursor:pointer;" title="in case your slide is copied from another source, add the name or the related URL of the original source"> <? echo _("+Add original source"); ?></a></small>
									...
									{{if current_user_id}}
										{{if current_user_id!=owner.id}}
											...
											{{if $value.is_followed_by_current_user==1}}
												<? echo _("Unfollow"); ?> ${$value.item_name}
											{{else}}<? echo _("Follow"); ?> ${$value.item_name}
											{{/if}}
											</a>
										{{/if}}
									{{/if}}
                                    ...
                                    <div class="slideTranslatedFrom" style="display:none">
                                    {{if $value.wasTranslatedFromRevision}}
                                    ${$value.wasTranslatedFromRevision}
                                    {{/if}}
                                                                         
                                    </div>
								<div class="slide-contributors" style="display:none;"><small><? echo _("Creator:"); ?></small><br/>
									...
									{{if $value.translator}}
                                                                        <small><? echo _("Translator:"); ?></small><br/>
										...
										{{if $value.contributors.length>1}}	<br/><small><? echo _("Contributors:"); ?></small><br/>					   		
			...
			<div id="edit">
				<div id="deck-edit" >
						...
						<ul>
							{{each users}}
								<li style="clear:both;margin-left:30%;">	
									<a target="_blank" href="user/${id}">${username}</a> <a class="pointer-cursor" onclick="remove_user_from_deck(${id},${$data.deck_id})"><img title="remove user" src="static/img/remove.png"></a> &nbsp;<input type="checkbox" id="apply_to_all_subdecks_${id}" name="apply_to_all_subdecks_${id}" value="1"> <? echo _("Delete from all sub decks"); ?>
								</li>
							{{/each}}
						</ul>
					</script>
					...
					<script id="add_editor" type="text/x-jquery-tmpl">
							<br/>
							<div class="clearfix">
								<label for="add_editor"><? echo _("Username or Email address:"); ?></label>
								<div class="input">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" id="apply_to_all_subdecks" name="apply_to_all_subdecks" value="1" checked> <? echo _("Assign editor to all sub decks belonging to owner"); ?>
							</div>					
					</script>
					<script id="add_editor_no" type="text/x-jquery-tmpl">
							...
							<div class="clearfix">
								<label for="add_editor"><? echo _("Username or Email address:"); ?></label>
								<div class="input">
									<input type="text" id = "editor_useremail" name="editor_useremail" class="span6" /><input type="button" class="btn" onclick="add_editor_action(${deck_id},0);" value="<? echo _('Add as editor'); ?>" />
								</div>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" id="apply_to_all_subdecks" name="apply_to_all_subdecks" value="1" checked><? echo _("Assign editor to all sub decks belonging to editor"); ?>
							</div>					
					</script>										
...
<!--                                                        <div class="clearfix">
                                                            <label for="language_visible"><? echo _("Language:"); ?></label> 
...
-->                                                     <div class="clearfix">
								<label for="tags"><? echo _("Footer text:"); ?></label>
								<div class="input">
							...
							{{if initiator=='yes'}}
								<div class="clearfix">
									<label for="tags"><? echo _("Original Author:"); ?></label>
									<div class="input">
										<input id = "originator" type="text" name="deck[description]" value="${description}" class="span6"/><br><span class="help-inline"><? echo _("if the original author of the deck is different from the current owner"); ?></span>
									</div>
								</div>
							{{else}}
								{{if description!=null}}
							...
							<div class="clearfix">
								<label for="theme"><? echo _("Default transition:"); ?></label>
								<div class="input">
							...
							{{if owner=='yes'}}
								<div class="clearfix">
									...
									<div class="input">
										<input type="radio" name="deck[visibility]" value="1" {{if $data.visibility==1}}checked{{/if}}> 
                                                                                <? echo _("visible"); ?> 
										<input type="radio" name="deck[visibility]" value="0" {{if $data.visibility==0}}checked{{/if}}> 
                                                                                <? echo _("invisible"); ?>
 										<br />
								...
								<div class="clearfix">
									...
									<? echo _("Number of editors:"); ?><b><a class="pointer-cursor" id="editor_no" title="show editors list"                                                                                    onclick="show_editors(${id},0)">${editor}</a></b>									-> <a class="pointer-cursor" title="add editor" id="add_desc" onclick="add_editor(${id},1)">
                                                                        {{if editor==0}} 
                                                                            <? echo _("Add one"); ?>
                                                                        {{else}}
                                                                            <? echo _("Add more"); ?>
							...
							{{else}}
								...
								<div class="clearfix">
										<label for="visibility"><? echo _("Visibility:"); ?></label>
										<div class="input">
											<input type="radio" name="deck[visibility]" value="1" {{if $data.visibility==1}}checked{{/if}}>                                                                                             <? echo _("visible"); ?> 
											<input type="radio" name="deck[visibility]" value="0" {{if $data.visibility==0}}checked{{/if}}>                                                                                             <? echo _("invisible"); ?>
 											<br /><span class="help-inline">
                                                                                            <? echo _("prevents your deck to get appeared in SlideWiki home page"); ?></span>
										</div>
									</div>	
								{{/if}}	
								<div class="clearfix">
									<label for="editor"></label>
									<? echo _("Number of editors:"); ?> <b><a class="pointer-cursor" id="editor_no" title="show editors list" 
                                                                                    onclick="show_editors(${id},1)">${editor}</a></b>
								{{if editors=='yes'}}
									-> <a class="pointer-cursor" title="add editor" id="add_desc" onclick="add_editor(${id},0)">
                                                                        {{if editor==0}} <? echo _("Add one"); ?>
                                                                        {{else}} <? echo _("Add more"); ?>
                                                                        {{/if}}</a>
								{{/if}}	
								<div id="editors"></div>
								</div>	
							...
							<div class="actions">
								{{if owner=='yes'}}
									{{if cascade_update==1}}
										<input type="checkbox" name="deck[cascade_update]" value="1" /> <? echo _("Update all instances"); ?>
									{{/if}}
									<input type="hidden" value="${save_as_new_revision}" name="deck[save_as_new_revision]" />
									<input type="button" class="btn primary" onclick="saveDeck(${id});" value="<? echo _('Save'); ?>" />
								{{else}}	
									{{if editors=='yes'}}
									<input type="hidden" value="${save_as_new_revision}" name="deck[save_as_new_revision]" />
									<input type="button" class="btn primary" onclick="saveDeck(${id});" value="<? echo _('Save'); ?>" />
									{{/if}}							
								{{/if}}
								<input type="button" class="btn primary" onclick="newDeckRevision(${id})" value="<? echo _('Create copy & Save!'); ?>" />
							</div>
			...
			<div id="discussion">
				<div id="item-discussion">
					...
					<script id="item_discussion" type="text/x-jquery-tmpl">
						...
						{{/each}}
						<li>
						<a class="btn" onclick="addComment($(this),'{{if item_name=='slide'}}slide{{else}}deck{{/if}}',${id})"><? echo _("Add new Comment"); ?></a>
						</li>
						{{if item_name=='deck'}}
							<br/><li>
                                                        <a class="btn primary small" onclick="show_subdecks_comments(${id})"><? echo _("Show sub deck/slide comments"); ?></a></li>
			...
			<div id="questions">
				...
				<div id="itemquestions"><a href="static/test/<?php echo $deck->id;?>">(<? echo _("Plain list of questions"); ?></a></div>
	     	   	...
	     	   	<script id="item_questions" type="text/x-jquery-tmpl">
                            ...
                            <div class="form-stacked" align="right">
                                    <div>
                                            <button class="btn primary" onclick="addQuestion(${id})"><? echo _("Add new Question"); ?></button>
                                    </div>
                            </div>
                            {{/if}}
                                ...
                                <div class="modal-body">
                                    ...
                                    <div>
                                        <form id="pdf_form" name="pdf_form">
                                            <legend>
                                                <h4><? echo _("Choose, how to show the alternatives for questions:"); ?></h4>
                                            </legend>
                                            <fieldset>
                                                <div class="input">
                                                    <input type="radio" name="show_answers" value="2" onChange="pdfExport(${id})" checked>
                                                    <? echo _("Highlight correct alternatives"); ?> 
                                                </div>
                                                <div class="input">
                                                    <input type="radio" name="show_answers" value="1" onChange="pdfExport(${id})">
                                                    <? echo _("Show alternatives without highlighting"); ?> 
                                                </div>
                                                <div class="input">
                                                    <input type="radio" name="show_answers" value="0" onChange="pdfExport(${id})">
                                                    <? echo _("Don't show alternatives"); ?> 
                                                </div>
                                            </fieldset>
                                            <div class="form-actions" align="center">
                                                <a id="submitPdf" class="btn primary" style="cursor:pointer" href="./?url=pdf/test&id=${id}&show_answers=2" target="_blank">
                                                    <? echo _("Export in PDF"); ?>
                                                </a>
                                            </div>
                            ...
                            {{if item_name=='deck' && questions.accepted.length}}
                                <a style="float:left;" class="btn success" href="./?url=main/tests&id=${id}&type=auto" onclick = "return !window.open(this.href)">
                                    <? echo _("Go to test"); ?>
                                </a>
                                <a style="float:left;" class="btn success" href="./?url=main/tests&id=${id}&type=exam" onclick = "return !window.open(this.href)">
                                    <? echo _("Exam mode"); ?>
                                </a>
                                <a style="float:left;" class="btn primary" style="cursor:pointer" onclick="pdfOpenModal()">
                                    <? echo _("Export in PDF"); ?>
                                </a>
                                <a style="float:right" href="/static/test/${id}" style="cursor:pointer">( <? echo _("Plain list"); ?> )</a>
                                
                            {{/if}}
                            {{if item_name=='deck' && !questions.accepted.length}}
                                <center><div data-alert="alert" class="alert-message error">
                                        <? echo _("There is no questions for chosen deck. Go to any of its slides to add questions."); ?>
                                </div></center>
                            {{/if}}
                            ...
                            <?php if ($user['is_authorized']) {?>
                                    <div class="inner-modal" id="question_form" style="clear:both; display:{{if item_name=='deck'}} none {{else}} block {{/if}}">
                                            ...
                                            <div class="form-stacked" id="questions-new-question">
                                                <fieldset>
                                                    <legend id="add_edit_title"><? echo _("Add new Question"); ?></legend>
                                                    <ul class="tabs" data-tabs="tabs">
                                                        <li class="active"><a href="#q_edit" id="qeditlink"><span><? echo _("Edit"); ?></span></a></li>
                                                        <li><a href="#q_revisions" id="qrevlink"><span><? echo _("History"); ?></span></a></li>					
                                                    </ul>
                                                    ...
                                                    <div id="q_edit" class="active">
                                                        ...
                                                        <div id="answer_row">
                                                                ...
                                                                <div class="actions" id="save_question">
                                                                        <button class="btn primary" onclick="saveQuestion('${id}','')"><? echo _("Save"); ?></button>
                                                                </div>
                                                        </div>
                                                    </div>
                                                    <!-- History tab -->
                                            ...
                                            {{each(i, value) revisions}}
                                                <li style="clear:both">
                                                    ...
                                                    {{if value.translated_from_revision && $data.parent_language.name}}
                                                        (<? echo _('Translated from <a href="slide/${value.translated_from_revision}">${$data.parent_language.name} version'); ?>
                                                    ...
                                                    {{if i!=$data.revisions.length-1}}
                                                            (<small>
                                                            <a style="color:#888855;" target="_blank" href="?url=compare/reportSlideChanges&slide=${value.id}">
                                                                <? echo _("Diff with previous revision"); ?>
                                                            </a></small>)
                                                    {{/if}}
                                                    <br />
                                                    <a href="slide/${value.id}" target="_blank">
                                                        <div class="sliderevision deck-menu deck-container">
                                                            <div class="slide">{{html value.content}}</div>
                                                        </div>
                                                    ...
                                                    {{if value.id!=$data.id}}
                                                        {{if $data.current_user!=0}}
                                                            <a class="pointer-cursor" onclick="replaceItem('${value.id}','slide')">
                                                                <? echo _("Use this revision"); ?>
                                                            </a>
                                                        {{/if}}
                                                    {{/if}}
                                                </li>
						...
						<br style="clear:both" />						
                                    ...
                                    <script id="deck_history" type="text/x-jquery-tmpl">
                                        ...
                                        <div class="alert-message fade in warning">
                                            ...
                                            <? echo _("The source deck for the translation was modified!"); ?> 
                                            <a style="cursor:pointer" onClick="showParentChanges(${id})">
                                            <? echo _("Click </a> to see the changes and update the deck."); ?>
                                        </div>
                                        {{/if}}
                                        <ul>
                                            {{each(i, value) revisions}}
                                                <li style="clear:both">
                                                    ...
                                                    {{if value.parent_language.name}}
                                                       (<? echo _('Translated from <a href="deck/${value.translated_from_revision}">${value.parent_language.name} version</a>'); ?>
                                                    {{/if}}
                                                    {{if i!=$data.revisions.length-1}}
                                                            (<small><a style="color:#888855;" class="pointer-cursor" href="?url=compare/compareDecks&deck=${value.id}" target="_blank">
                                                                    <? echo _("Diff with previous revision"); ?>
                                                            </a></small>)
                                                    ...
                                                    {{if value.id!=$data.id}}
                                                            {{if $data.current_user!=0}}
                                                                    -><a class="pointer-cursor" onclick="replaceItem('${value.id}','deck')">
                                                                        <? echo _("Use this revision"); ?>
                                                                    </a>
                                                            {{/if}}
                                                    {{/if}}
...
*/
$('#KeynodePlaySlide').click(function(e) {
        ...
        var popup = window.open(link, 'popup_presenter', options);
        popup.moveTo(0, 0);
        var popup2 = window.open("<?php echo ($keynode_canonical); ?>", 'popup_secondmonitor', options);
        popup2.moveTo(0, 0);
        e.preventDefault();
        return false;
    });
