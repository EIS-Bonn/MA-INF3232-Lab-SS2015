                ...
                <div id="profile">
                    ...
                    <script id="full_profile_script" type="text/x-jquery-tmpl">
                        <form id="save_full_profile" class="form-stacked" action="./?url=ajax/saveProfile&id=<?php echo $_GET['id'];?>" method="POST">
                            <legend><h3>Your public profile: <a onclick="getFBProfile()" style="cursor:pointer"><img title="Update from facebook" src="static/img/facebook.jpg" width="20px"></a></h3></legend>
                            <fieldset>
                                <div class="row">
                                    <div class="span5">
                                        <div class="clearfix">
