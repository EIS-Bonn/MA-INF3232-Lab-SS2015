...
- GreenEnergyShifting:
   The final version of the Android application as Eclipse project.

- GreenEnergyTest:
   The final version of the JUnit-testing application for the Android application. This is also an Eclipse project.
...
- GroupH_GreenEnergy_Login(02_07_1014):
   An earlier version of the Android application from July 2nd 2014. This is also an Eclipse project
